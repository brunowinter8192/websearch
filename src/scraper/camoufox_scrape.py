...
async def scrape_url_camoufox_workflow(url: str, block_images: bool = False) -> list[TextContent]:
    ...
    log_scrape(_build_scrape_record(ts, url, domain, content, meta, total_wall, content_path))
...
def _build_scrape_record(
    ts: str, url: str, domain: str, content: str, meta: dict, total_wall: int, content_path: str | None,
) -> dict:
    return {
