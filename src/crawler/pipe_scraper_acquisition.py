...
from src.crawler.pipe_scraper_pacing import ensure_domain_state, gate_domain
from src.crawler.pipe_scraper_records import log_pipe_record, log_pipe_camoufox_record
...
async def scrape_one(
    ...
    state = ensure_domain_state(domain_states, domain, concurrency_per_domain)
    async with state['sem']:
        await gate_domain(state, download_delay)
...
async def scrape_one_camoufox(
    ...
    log_pipe_camoufox_record(run_ctx, ts, url, domain, status, byte_count, wall_ms, meta)
