...
## Modules
None at this level. Area subdirectories: access_recovery, agentic_discovery, browser_posture, brave_return, engine_reduction, explore_pipeline, lane_choice, logging, mojeek_return, news_pipeline, scrape_pipeline, search_pipeline, tests, url_discovery. `_lib/` is the dev-wide shared package; check it before writing an OS-level launch or process-control primitive inline in a probe.
