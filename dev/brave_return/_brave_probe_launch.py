...
async def launch_browser(profile_dir: str, bundle_path: Path) -> LaunchedBrowser:
    ...
    logger.info("Launched Chrome on %s (bundle=%s, port=%s, pids=%s)", profile_dir, bundle_path, port, owned_pids)
