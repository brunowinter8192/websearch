...
4. **Extraction.** 336 helpers in 119 files were inlined back by `07_inline_equivalence.py`: 0 problems. Hand-edited files (20) are listed in that report with the reason.
